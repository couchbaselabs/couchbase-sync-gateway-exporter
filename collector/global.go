...
func (c *globalCollector) Collect(ch chan<- prometheus.Metric, metrics client.ResourceUtilization) {
	ch <- prometheus.MustNewConstMetric(c.adminNetBytesRecv, prometheus.CounterValue, metrics.AdminNetBytesRecv)
	ch <- prometheus.MustNewConstMetric(c.adminNetBytesSent, prometheus.CounterValue, metrics.AdminNetBytesSent)
	ch <- prometheus.MustNewConstMetric(c.errorCount, prometheus.CounterValue, metrics.ErrorCount)
	ch <- prometheus.MustNewConstMetric(c.goMemstatsHeapalloc, prometheus.GaugeValue, metrics.GoMemstatsHeapalloc)
	ch <- prometheus.MustNewConstMetric(c.goMemstatsHeapidle, prometheus.GaugeValue, metrics.GoMemstatsHeapidle)
	ch <- prometheus.MustNewConstMetric(c.goMemstatsHeapinuse, prometheus.GaugeValue, metrics.GoMemstatsHeapinuse)
	ch <- prometheus.MustNewConstMetric(c.goMemstatsHeapreleased, prometheus.GaugeValue, metrics.GoMemstatsHeapreleased)
	ch <- prometheus.MustNewConstMetric(c.goMemstatsPausetotalns, prometheus.CounterValue, metrics.GoMemstatsPausetotalns)
	ch <- prometheus.MustNewConstMetric(c.goMemstatsStackinuse, prometheus.GaugeValue, metrics.GoMemstatsStackinuse)
	ch <- prometheus.MustNewConstMetric(c.goMemstatsStacksys, prometheus.GaugeValue, metrics.GoMemstatsStacksys)
	ch <- prometheus.MustNewConstMetric(c.goMemstatsSys, prometheus.GaugeValue, metrics.GoMemstatsSys)
	ch <- prometheus.MustNewConstMetric(c.goroutinesHighWatermark, prometheus.GaugeValue, metrics.GoroutinesHighWatermark)
	ch <- prometheus.MustNewConstMetric(c.numGoroutines, prometheus.GaugeValue, metrics.NumGoroutines)
	...
	ch <- prometheus.MustNewConstMetric(c.pubNetBytesRecv, prometheus.CounterValue, metrics.PubNetBytesRecv)
	ch <- prometheus.MustNewConstMetric(c.pubNetBytesSent, prometheus.CounterValue, metrics.PubNetBytesSent)
	ch <- prometheus.MustNewConstMetric(c.systemMemoryTotal, prometheus.GaugeValue, metrics.SystemMemoryTotal)
	ch <- prometheus.MustNewConstMetric(c.warnCount, prometheus.CounterValue, metrics.WarnCount)
}
