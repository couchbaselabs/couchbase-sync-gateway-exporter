...
func TestMetricsSimple(t *testing.T) {
	...
	testCollector(t, collector, func(t *testing.T, status int, body string) {
		...
		requireCounter(t, body, `sgw_database_num_replications_total{database="travel-sample"} 0`)
		...
		requireCounter(t, body, `sgw_gsi_views_access_count{database="travel-sample"} 3`)
		requireCounter(t, body, `sgw_gsi_views_channels_count{database="travel-sample"} 0`)
		requireCounter(t, body, `sgw_gsi_views_roleAccess_count{database="travel-sample"} 3`)
		...
		requireCounter(t, body, `sgw_replication_pull_rev_send_latency{database="travel-sample"} 0`)
		...
		requireCounter(t, body, `sgw_replication_push_conflict_write_count{database="travel-sample"} 0`)
		...
		requireCounter(t, body, `sgw_security_auth_failed_count{database="travel-sample"} 0`)
		requireCounter(t, body, `sgw_security_auth_success_count{database="travel-sample"} 0`)
...
func TestMetricsWithReplication(t *testing.T) {
	...
	testCollector(t, collector, func(t *testing.T, status int, body string) {
		...
		requireCounter(t, body, `sgw_database_num_replications_total{database="travel-sample"} 570`)
		requireCounter(t, body, `sgw_database_sequence_get_count{database="travel-sample"} 1`)
		requireCounter(t, body, `sgw_database_sequence_released_count{database="travel-sample"} 0`)
		...
		requireCounter(t, body, `sgw_database_warn_grants_per_doc_count{database="travel-sample"} 0`)
		requireCounter(t, body, `sgw_database_warn_xattr_size_count{database="travel-sample"} 0`)
		requireCounter(t, body, `sgw_gsi_views_access_count{database="travel-sample"} 0`)
		requireCounter(t, body, `sgw_gsi_views_channels_count{database="travel-sample"} 563`)
		requireCounter(t, body, `sgw_gsi_views_roleAccess_count{database="travel-sample"} 0`)
		requireCounter(t, body, `sgw_replication_pull_attachment_pull_bytes{database="travel-sample"} 0`)
		requireCounter(t, body, `sgw_replication_pull_attachment_pull_count{database="travel-sample"} 0`)
		...
		requireCounter(t, body, `sgw_replication_pull_rev_send_latency{database="travel-sample"} 8.322484988e+11`)
		requireCounter(t, body, `sgw_replication_push_attachment_push_bytes{database="travel-sample"} 0`)
		requireCounter(t, body, `sgw_replication_push_attachment_push_count{database="travel-sample"} 0`)
		requireCounter(t, body, `sgw_replication_push_conflict_write_count{database="travel-sample"} 0`)
		...
		requireCounter(t, body, `sgw_security_auth_failed_count{database="travel-sample"} 0`)
		requireCounter(t, body, `sgw_security_auth_success_count{database="travel-sample"} 3`)
		requireCounter(t, body, `sgw_security_num_access_errors{database="travel-sample"} 0`)
		requireCounter(t, body, `sgw_security_num_docs_rejected{database="travel-sample"} 0`)
