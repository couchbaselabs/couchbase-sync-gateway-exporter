...
func TestMetricsSimple(t *testing.T) {
	...
	testCollector(t, collector, func(t *testing.T, status int, body string) {
		...
		requireGauge(t, body, `sgw_cache_chan_cache_hits{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_cache_chan_cache_max_entries{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_cache_chan_cache_misses{database="travel-sample"} 0`)
		...
		requireGauge(t, body, `sgw_cache_num_skipped_seqs{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_cache_rev_cache_hits{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_cache_rev_cache_misses{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_database_abandoned_seqs{database="travel-sample"} 0`)
		...
		requireGauge(t, body, `sgw_database_doc_reads_bytes_blip{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_database_doc_writes_bytes{database="travel-sample"} 2.274404e+06`)
		requireGauge(t, body, `sgw_database_doc_writes_bytes_blip{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_database_num_doc_reads_blip{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_database_num_doc_reads_rest{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_database_num_doc_writes{database="travel-sample"} 2100`)
		...
		requireGauge(t, body, `sgw_database_sequence_get_count{database="travel-sample"} 1`)
		requireGauge(t, body, `sgw_database_sequence_released_count{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_database_sequence_reserved_count{database="travel-sample"} 2105`)
		requireGauge(t, body, `sgw_database_warn_channels_per_doc_count{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_database_warn_grants_per_doc_count{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_database_warn_xattr_size_count{database="travel-sample"} 0`)
		...
		requireGauge(t, body, `sgw_replication_pull_attachment_pull_bytes{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_replication_pull_attachment_pull_count{database="travel-sample"} 0`)
		...
		requireGauge(t, body, `sgw_replication_pull_num_pull_repl_since_zero{database="travel-sample"} 0`)
		...
		requireGauge(t, body, `sgw_replication_pull_request_changes_count{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_replication_pull_request_changes_time{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_replication_pull_rev_processing_time{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_replication_pull_rev_send_count{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_replication_pull_rev_send_latency{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_replication_push_attachment_push_bytes{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_replication_push_attachment_push_count{database="travel-sample"} 0`)
		...
		requireGauge(t, body, `sgw_replication_push_propose_change_count{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_replication_push_propose_change_time{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_replication_push_sync_function_count{database="travel-sample"} 2101`)
		requireGauge(t, body, `sgw_replication_push_sync_function_time{database="travel-sample"} 3.21153379e+08`)
		requireGauge(t, body, `sgw_replication_push_write_processing_time{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_resource_utilization_admin_net_bytes_recv 0`)
		requireGauge(t, body, `sgw_resource_utilization_admin_net_bytes_sent 0`)
		requireGauge(t, body, `sgw_resource_utilization_error_count 2`)
		...
		requireGauge(t, body, `sgw_resource_utilization_go_memstats_pausetotalns 0`)
		...
		requireGauge(t, body, `sgw_resource_utilization_pub_net_bytes_recv 0`)
		requireGauge(t, body, `sgw_resource_utilization_pub_net_bytes_sent 0`)
		requireGauge(t, body, `sgw_resource_utilization_system_memory_total 0`)
		requireGauge(t, body, `sgw_resource_utilization_warn_count 4`)
		...
		requireGauge(t, body, `sgw_security_num_access_errors{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_security_num_docs_rejected{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_security_total_auth_time{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_shared_bucket_import_import_count{database="travel-sample"} 2100`)
		requireGauge(t, body, `sgw_shared_bucket_import_import_error_count{database="travel-sample"} 0`)
		// nolint: lll
...
func TestMetricsWithReplication(t *testing.T) {
	...
	testCollector(t, collector, func(t *testing.T, status int, body string) {
		...
		requireGauge(t, body, `sgw_cache_chan_cache_hits{database="travel-sample"} 3685`)
		requireGauge(t, body, `sgw_cache_chan_cache_max_entries{database="travel-sample"} 50`)
		requireGauge(t, body, `sgw_cache_chan_cache_misses{database="travel-sample"} 563`)
		requireGauge(t, body, `sgw_cache_chan_cache_num_channels{database="travel-sample"} 3`)
		requireGauge(t, body, `sgw_cache_chan_cache_pending_queries{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_cache_chan_cache_removal_revs{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_cache_chan_cache_tombstone_revs{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_cache_num_skipped_seqs{database="travel-sample"} 2400`)
		requireGauge(t, body, `sgw_cache_rev_cache_hits{database="travel-sample"} 76`)
		requireGauge(t, body, `sgw_cache_rev_cache_misses{database="travel-sample"} 37935`)
		requireGauge(t, body, `sgw_database_abandoned_seqs{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_database_crc32c_match_count{database="travel-sample"} 0`)
		...
		requireGauge(t, body, `sgw_database_doc_reads_bytes_blip{database="travel-sample"} 2.109825e+07`)
		requireGauge(t, body, `sgw_database_doc_writes_bytes{database="travel-sample"} 2.1098263e+07`)
		requireGauge(t, body, `sgw_database_doc_writes_bytes_blip{database="travel-sample"} 13`)
		requireGauge(t, body, `sgw_database_num_doc_reads_blip{database="travel-sample"} 10032`)
		requireGauge(t, body, `sgw_database_num_doc_reads_rest{database="travel-sample"} 27979`)
		requireGauge(t, body, `sgw_database_num_doc_writes{database="travel-sample"} 10033`)
		...
		requireGauge(t, body, `sgw_database_sequence_get_count{database="travel-sample"} 1`)
		requireGauge(t, body, `sgw_database_sequence_released_count{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_database_sequence_reserved_count{database="travel-sample"} 10034`)
		requireGauge(t, body, `sgw_database_warn_channels_per_doc_count{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_database_warn_grants_per_doc_count{database="travel-sample"} 0`)
		requireGauge(t, body, `sgw_database_warn_xattr_size_count{database="travel-sample"} 0`)
		...
		requireGauge(t, body, `sgw_replication_pull_request_changes_count{database="travel-sample"} 1984`)
		requireGauge(t, body, `sgw_replication_pull_request_changes_time{database="travel-sample"} 2.8729243e+10`)
		requireGauge(t, body, `sgw_replication_pull_rev_processing_time{database="travel-sample"} 1.028721848e+11`)
		requireGauge(t, body, `sgw_replication_pull_rev_send_count{database="travel-sample"} 10032`)
		...
		requireGauge(t, body, `sgw_replication_push_propose_change_count{database="travel-sample"} 1`)
		requireGauge(t, body, `sgw_replication_push_propose_change_time{database="travel-sample"} 6.0633e+06`)
		requireGauge(t, body, `sgw_replication_push_sync_function_count{database="travel-sample"} 10033`)
		requireGauge(t, body, `sgw_replication_push_sync_function_time{database="travel-sample"} 1.2717184e+09`)
		requireGauge(t, body, `sgw_replication_push_write_processing_time{database="travel-sample"} 1.002994e+08`)
		requireGauge(t, body, `sgw_replication_sgr_docs_checked_sent{replication="repl-1"} 0`)
		requireGauge(t, body, `sgw_replication_sgr_docs_checked_sent{replication="repl-101"} 0`)
		requireGauge(t, body, `sgw_replication_sgr_docs_checked_sent{replication="repl-102"} 7828`)
		requireGauge(t, body, `sgw_replication_sgr_docs_checked_sent{replication="repl-102-pull"} 27978`)
		requireGauge(t, body, `sgw_replication_sgr_num_attachment_bytes_transferred{replication="repl-1"} 0`)
		requireGauge(t, body, `sgw_replication_sgr_num_attachment_bytes_transferred{replication="repl-101"} 0`)
		requireGauge(t, body, `sgw_replication_sgr_num_attachment_bytes_transferred{replication="repl-102"} 0`)
		requireGauge(t, body, `sgw_replication_sgr_num_attachment_bytes_transferred{replication="repl-102-pull"} 0`)
		requireGauge(t, body, `sgw_replication_sgr_num_attachments_transferred{replication="repl-1"} 0`)
		requireGauge(t, body, `sgw_replication_sgr_num_attachments_transferred{replication="repl-101"} 0`)
		requireGauge(t, body, `sgw_replication_sgr_num_attachments_transferred{replication="repl-102"} 0`)
		requireGauge(t, body, `sgw_replication_sgr_num_attachments_transferred{replication="repl-102-pull"} 0`)
		requireGauge(t, body, `sgw_replication_sgr_num_docs_failed_to_push{replication="repl-1"} 0`)
		requireGauge(t, body, `sgw_replication_sgr_num_docs_failed_to_push{replication="repl-101"} 0`)
		requireGauge(t, body, `sgw_replication_sgr_num_docs_failed_to_push{replication="repl-102"} 0`)
		requireGauge(t, body, `sgw_replication_sgr_num_docs_failed_to_push{replication="repl-102-pull"} 0`)
		requireGauge(t, body, `sgw_replication_sgr_num_docs_pushed{replication="repl-1"} 0`)
		requireGauge(t, body, `sgw_replication_sgr_num_docs_pushed{replication="repl-101"} 0`)
		requireGauge(t, body, `sgw_replication_sgr_num_docs_pushed{replication="repl-102"} 7778`)
		requireGauge(t, body, `sgw_replication_sgr_num_docs_pushed{replication="repl-102-pull"} 0`)
		requireGauge(t, body, `sgw_resource_utilization_admin_net_bytes_recv 6.97856009e+08`)
		requireGauge(t, body, `sgw_resource_utilization_admin_net_bytes_sent 1.66156024e+08`)
		requireGauge(t, body, `sgw_resource_utilization_error_count 9`)
		...
		requireGauge(t, body, `sgw_resource_utilization_go_memstats_pausetotalns 2.3147789e+09`)
		...
		requireGauge(t, body, `sgw_resource_utilization_pub_net_bytes_recv 6.97856009e+08`)
		requireGauge(t, body, `sgw_resource_utilization_pub_net_bytes_sent 1.66156024e+08`)
		requireGauge(t, body, `sgw_resource_utilization_system_memory_total 4.139307008e+09`)
		requireGauge(t, body, `sgw_resource_utilization_warn_count 1`)
		requireGauge(t, body, `sgw_security_auth_failed_count{database="travel-sample"} 0`)
		...
		requireGauge(t, body, `sgw_shared_bucket_import_import_count{database="travel-sample"} 10031`)
		requireGauge(t, body, `sgw_shared_bucket_import_import_error_count{database="travel-sample"} 0`)
